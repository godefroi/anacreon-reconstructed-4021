...
/// hold/switch on one reference type instead of <c>object</c>. Fleet joins the other four once
/// ResolveAttack's fleet-target branch needs to fire <c>GLBConq</c>/<c>BattleL</c> with a destroyed
/// fleet as the news subject.
/// </summary>
