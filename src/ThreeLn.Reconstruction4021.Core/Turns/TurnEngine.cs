...
/// generated by that movement survives to next turn. Left un-wired since Phase 4 (no real consumer
/// existed to validate the timing against); Phase 6d's KingdomTurnHandler.ReviewNews is that
/// consumer now — without this, a standing NoFuel item would re-trigger SendRescueFleet every turn
/// forever (ReviewNews has no AlreadyTargetted guard on that path).
/// </remarks>
